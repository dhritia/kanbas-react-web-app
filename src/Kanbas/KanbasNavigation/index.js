...
import { FaBook, FaClock, FaDesktop, FaInbox, FaQuestion, FaSignOutAlt, FaTachometerAlt } from "react-icons/fa";
import { BsFillCalendar2WeekFill } from "react-icons/bs";
import logo from "../../Images/NEU.jpeg";
import "./index.css";
function KanbasNavigation() {
  ...
  return (
    <div className="list-group wd-kanbas-navigation">
            <img src = {logo} className="wd-icon"></img>
