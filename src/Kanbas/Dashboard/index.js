            ...
            <div className="p-2">
                <div className="card wd-card">
                    ...
                    <div class="card-body">
                        ...
                        <button className="btn btn-secondary m-2" onClick={(event) => { event.preventDefault(); setCourse(course);  }}>
                        <FaEdit/>Edit
                        </button>
                        <button className="btn btn-danger m-2" onClick={(event) => { event.preventDefault(); deleteCourse(course); }}>
                          <FaTrash/>Delete
                        </button>
                    </div>
                </div>
